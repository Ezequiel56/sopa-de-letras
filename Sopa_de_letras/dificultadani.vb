Public Class dificultadani
    ...
    Private Sub Label4_MouseEnter(ByVal sender As Object, ByVal e As EventArgs) Handles Label4.MouseEnter
        Label4.ForeColor = Color.White 'Cambia el color de la fuente de la label1

    End Sub

    Private Sub Label4_MouseLeave(ByVal sender As Object, ByVal e As EventArgs) Handles Label4.MouseLeave
        Label4.ForeColor = Color.Black 'Cambia el color de la fuente de la label1
    ...
    Private Sub dificultadani_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
